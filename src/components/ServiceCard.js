...
export default function ServiceCard({url, text, alt}) {
  return (
    <div className={`service__card relative w-[1000px] h-[300px] bg-white  rounded-xl`}>
        <Image src={url} fill alt={alt || "image"}  objectFit='cover' className='rounded-xl brightness-50 hover:brightness-[30%]'/>
